...
wb_mux
  #(.num_slaves (7),
    ...
    .MATCH_MASK ({32'hfe000000, 32'hffffffe0, 32'hfffffff0, 32'hfffffff0, 32'hfffffff0, 32'hfffffffe, 32'hfffffffe}))
 wb_mux_or1k_d
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    ...
    .wbs_adr_o ({wb_m2s_or1k_d_ddr_dbus_adr, wb_m2s_resize_uart0_adr, wb_spi0_adr_o, wb_spi1_adr_o, wb_spi2_adr_o, wb_m2s_resize_gpio0_adr, wb_m2s_resize_gpio1_adr}),
    .wbs_dat_o ({wb_m2s_or1k_d_ddr_dbus_dat, wb_m2s_resize_uart0_dat, wb_spi0_dat_o, wb_spi1_dat_o, wb_spi2_dat_o, wb_m2s_resize_gpio0_dat, wb_m2s_resize_gpio1_dat}),
    .wbs_sel_o ({wb_m2s_or1k_d_ddr_dbus_sel, wb_m2s_resize_uart0_sel, wb_spi0_sel_o, wb_spi1_sel_o, wb_spi2_sel_o, wb_m2s_resize_gpio0_sel, wb_m2s_resize_gpio1_sel}),
    .wbs_we_o  ({wb_m2s_or1k_d_ddr_dbus_we, wb_m2s_resize_uart0_we, wb_spi0_we_o, wb_spi1_we_o, wb_spi2_we_o, wb_m2s_resize_gpio0_we, wb_m2s_resize_gpio1_we}),
    .wbs_cyc_o ({wb_m2s_or1k_d_ddr_dbus_cyc, wb_m2s_resize_uart0_cyc, wb_spi0_cyc_o, wb_spi1_cyc_o, wb_spi2_cyc_o, wb_m2s_resize_gpio0_cyc, wb_m2s_resize_gpio1_cyc}),
    .wbs_stb_o ({wb_m2s_or1k_d_ddr_dbus_stb, wb_m2s_resize_uart0_stb, wb_spi0_stb_o, wb_spi1_stb_o, wb_spi2_stb_o, wb_m2s_resize_gpio0_stb, wb_m2s_resize_gpio1_stb}),
    .wbs_cti_o ({wb_m2s_or1k_d_ddr_dbus_cti, wb_m2s_resize_uart0_cti, wb_spi0_cti_o, wb_spi1_cti_o, wb_spi2_cti_o, wb_m2s_resize_gpio0_cti, wb_m2s_resize_gpio1_cti}),
    .wbs_bte_o ({wb_m2s_or1k_d_ddr_dbus_bte, wb_m2s_resize_uart0_bte, wb_spi0_bte_o, wb_spi1_bte_o, wb_spi2_bte_o, wb_m2s_resize_gpio0_bte, wb_m2s_resize_gpio1_bte}),
    .wbs_dat_i ({wb_s2m_or1k_d_ddr_dbus_dat, wb_s2m_resize_uart0_dat, wb_spi0_dat_i, wb_spi1_dat_i, wb_spi2_dat_i, wb_s2m_resize_gpio0_dat, wb_s2m_resize_gpio1_dat}),
    .wbs_ack_i ({wb_s2m_or1k_d_ddr_dbus_ack, wb_s2m_resize_uart0_ack, wb_spi0_ack_i, wb_spi1_ack_i, wb_spi2_ack_i, wb_s2m_resize_gpio0_ack, wb_s2m_resize_gpio1_ack}),
    .wbs_err_i ({wb_s2m_or1k_d_ddr_dbus_err, wb_s2m_resize_uart0_err, wb_spi0_err_i, wb_spi1_err_i, wb_spi2_err_i, wb_s2m_resize_gpio0_err, wb_s2m_resize_gpio1_err}),
    .wbs_rty_i ({wb_s2m_or1k_d_ddr_dbus_rty, wb_s2m_resize_uart0_rty, wb_spi0_rty_i, wb_spi1_rty_i, wb_spi2_rty_i, wb_s2m_resize_gpio0_rty, wb_s2m_resize_gpio1_rty}));
